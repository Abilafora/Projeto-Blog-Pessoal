...
public class Postagem {
	...
	@Size(min = 5, max = 1000, message = "O texto tem limite tem que ser maior que 5 e menos que 100o palavras")
	...
	private Tema tema; // adicionando o objeto tema (ide descricao
